...
Re-examing this particular function, the user could call the function directly and pass in any `_targetDna` or `_species` they want to. This isn't very game-like — we want them to follow our rules!
...
After implementing this, our `zombiehelper.sol` should look like this: 
```
pragma solidity ^0.4.19;
